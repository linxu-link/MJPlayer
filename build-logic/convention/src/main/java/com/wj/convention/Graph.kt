...
internal enum class PluginType(val id: String, val ref: String, val style: String) {
    AndroidApplication(
        id = plugin_convention_app,
        ref = "android-application",
        style = "fill:#CAFFBF,stroke:#000,stroke-width:2px,color:#000", // 浅绿色
    ),
    AndroidFeature(
        id = plugin_convention_feature,
        ref = "android-feature",
        style = "fill:#FFD6A5,stroke:#000,stroke-width:2px,color:#000", // 橙色
    ),
    AndroidTest(
        id = plugin_convention_android_test,
        ref = "android-test",
        style = "fill:#A0C4FF,stroke:#000,stroke-width:2px,color:#000",
    ),
    AndroidLibrary(
        id = plugin_convention_lib,
        ref = "android-library",
        style = "fill:#9BF6FF,stroke:#000,stroke-width:2px,color:#000", // 蓝色
    ),
    Jvm(
        id = plugin_convention_lib_jvm,
        ref = "jvm-library",
        style = "fill:#BDB2FF,stroke:#000,stroke-width:2px,color:#000", // 紫色
    ),
    Unknown(
        id = "?",
        ref = "unknown",
        style = "fill:#FFADAD,stroke:#000,stroke-width:2px,color:#000", // 红色（错误）
    ),
}
